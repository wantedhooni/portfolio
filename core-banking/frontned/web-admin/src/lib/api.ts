...
import type {ApiResponse, AdminAuthResponse, RefreshTokenRequest} from '@/types';
...
export async function callRefresh(refreshToken: string): Promise<AdminAuthResponse> {
