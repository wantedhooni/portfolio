...
import com.revy.app.broker.KafkaConsumer;
...
public class JhipsterAppKafkaResource {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(JhipsterAppKafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public JhipsterAppKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
